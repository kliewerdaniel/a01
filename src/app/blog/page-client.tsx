        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between py-4 gap-4">
          <div className="flex items-center gap-2">
            <Button
              ...
              className={cn(
                viewMode === 'list' ? 'bg-foreground text-background' : 'border-border text-muted-foreground hover:border-white hover:text-white'
              )}
            >
              List View
            </Button>
            <Button
              ...
              className={cn(
                viewMode === 'graph' ? 'bg-foreground text-background' : 'border-border text-muted-foreground hover:border-white hover:text-white'
              )}
            >
              Graph View
            </Button>
